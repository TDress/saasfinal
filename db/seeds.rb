default_users = [
  {:id => 50, :linkedin_id => 5555555, :is_admin => 0,
    :name => 'John P', :email => 'john.professor@example.com'},
  {:id => 51, :linkedin_id => 55555555, :is_admin => 0,
...
default_posts = [
  {:user_id => 1, :title => 'First Job', :created_on => Time.now - rand(2400.hours),
  	:content =>
  ...
  {:user_id => 0, :title => 'Last Job', :created_on => Time.now - rand(2400.hours),
  	:content =>
